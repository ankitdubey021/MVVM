...
import database.AddTaskViewModel;
import database.AddTaskViewModelFactory;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null && intent.hasExtra(EXTRA_TASK_ID)) {
            ...
            if (mTaskId == DEFAULT_TASK_ID) {
                ...
                AddTaskViewModelFactory factor=new AddTaskViewModelFactory(mDb,mTaskId);
                AddTaskViewModel viewModel=
                        ViewModelProviders.of(this,factor).get(AddTaskViewModel.class);
